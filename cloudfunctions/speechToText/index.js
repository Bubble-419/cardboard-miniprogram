...
exports.main = async (event) => {
  ...
  try {
    ...
    if (!session || session.mode !== "PARTNER" || session.sessionId !== sessionId || !turn || turn.turnId !== turnId || !["PARTNER_TURN", "PARTNER_STATEMENT"].includes(session.workflow.step)) {
    ...
    return {
      ok: false,
      errCode: error.errCode || error.code || "DEPENDENCY_UNAVAILABLE",
